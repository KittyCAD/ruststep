...
pub mod config_control_design {
    ...
    static COMPLETE: ::phf::Map<&'static str, &'static [&'static str]> = ::phf::phf_map! { "ACTION" => & ["name" , "description" , "chosen_method" ,] , "ACTION_ASSIGNMENT" => & ["assigned_action" ,] , "ACTION_DIRECTIVE" => & ["name" , "description" , "analysis" , "comment" , "requests" ,] , "ACTION_METHOD" => & ["name" , "description" , "consequence" , "purpose" ,] , "ACTION_REQUEST_ASSIGNMENT" => & ["assigned_action_request" ,] , "ACTION_REQUEST_SOLUTION" => & ["method" , "request" ,] , "ACTION_REQUEST_STATUS" => & ["status" , "assigned_request" ,] , "ACTION_STATUS" => & ["status" , "assigned_action" ,] , "ADDRESS" => & ["internal_location" , "street_number" , "street" , "postal_box" , "town" , "region" , "postal_code" , "country" , "facsimile_number" , "telephone_number" , "electronic_mail_address" , "telex_number" ,] , "ADVANCED_BREP_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "ADVANCED_FACE" => & ["name" , "bounds" , "face_geometry" , "same_sense" ,] , "ALTERNATE_PRODUCT_RELATIONSHIP" => & ["name" , "definition" , "alternate" , "base" , "basis" ,] , "APPLICATION_CONTEXT" => & ["application" ,] , "APPLICATION_CONTEXT_ELEMENT" => & ["name" , "frame_of_reference" ,] , "APPLICATION_PROTOCOL_DEFINITION" => & ["status" , "application_interpreted_model_schema_name" , "application_protocol_year" , "application" ,] , "APPROVAL" => & ["status" , "level" ,] , "APPROVAL_ASSIGNMENT" => & ["assigned_approval" ,] , "APPROVAL_DATE_TIME" => & ["date_time" , "dated_approval" ,] , "APPROVAL_PERSON_ORGANIZATION" => & ["person_organization" , "authorized_approval" , "role" ,] , "APPROVAL_RELATIONSHIP" => & ["name" , "description" , "relating_approval" , "related_approval" ,] , "APPROVAL_ROLE" => & ["role" ,] , "APPROVAL_STATUS" => & ["name" ,] , "AREA_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "AREA_UNIT" => & ["dimensions" ,] , "ASSEMBLY_COMPONENT_USAGE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" , "reference_designator" ,] , "ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE" => & ["name" , "definition" , "base" , "substitute" ,] , "AXIS1_PLACEMENT" => & ["name" , "location" , "axis" ,] , "AXIS2_PLACEMENT_2D" => & ["name" , "location" , "ref_direction" ,] , "AXIS2_PLACEMENT_3D" => & ["name" , "location" , "axis" , "ref_direction" ,] , "B_SPLINE_CURVE" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" ,] , "B_SPLINE_CURVE_WITH_KNOTS" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" , "knot_multiplicities" , "knots" , "knot_spec" ,] , "B_SPLINE_SURFACE" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" ,] , "B_SPLINE_SURFACE_WITH_KNOTS" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" , "u_multiplicities" , "v_multiplicities" , "u_knots" , "v_knots" , "knot_spec" ,] , "BEZIER_CURVE" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" ,] , "BEZIER_SURFACE" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" ,] , "BOUNDARY_CURVE" => & ["name" , "segments" , "self_intersect" ,] , "BOUNDED_CURVE" => & ["name" ,] , "BOUNDED_PCURVE" => & ["name" , "basis_surface" , "reference_to_curve" ,] , "BOUNDED_SURFACE" => & ["name" ,] , "BOUNDED_SURFACE_CURVE" => & ["name" , "curve_3d" , "associated_geometry" , "master_representation" ,] , "BREP_WITH_VOIDS" => & ["name" , "outer" , "voids" ,] , "CALENDAR_DATE" => & ["year_component" , "day_component" , "month_component" ,] , "CARTESIAN_POINT" => & ["name" , "coordinates" ,] , "CARTESIAN_TRANSFORMATION_OPERATOR" => & ["name" , "description" , "axis1" , "axis2" , "local_origin" , "scale" ,] , "CARTESIAN_TRANSFORMATION_OPERATOR_3D" => & ["name" , "description" , "axis1" , "axis2" , "local_origin" , "scale" , "axis3" ,] , "CC_DESIGN_APPROVAL" => & ["assigned_approval" , "items" ,] , "CC_DESIGN_CERTIFICATION" => & ["assigned_certification" , "items" ,] , "CC_DESIGN_CONTRACT" => & ["assigned_contract" , "items" ,] , "CC_DESIGN_DATE_AND_TIME_ASSIGNMENT" => & ["assigned_date_and_time" , "role" , "items" ,] , "CC_DESIGN_PERSON_AND_ORGANIZATION_ASSIGNMENT" => & ["assigned_person_and_organization" , "role" , "items" ,] , "CC_DESIGN_SECURITY_CLASSIFICATION" => & ["assigned_security_classification" , "items" ,] , "CC_DESIGN_SPECIFICATION_REFERENCE" => & ["assigned_document" , "source" , "items" ,] , "CERTIFICATION" => & ["name" , "purpose" , "kind" ,] , "CERTIFICATION_ASSIGNMENT" => & ["assigned_certification" ,] , "CERTIFICATION_TYPE" => & ["description" ,] , "CHANGE" => & ["assigned_action" , "items" ,] , "CHANGE_REQUEST" => & ["assigned_action_request" , "items" ,] , "CIRCLE" => & ["name" , "position" , "radius" ,] , "CLOSED_SHELL" => & ["name" , "cfs_faces" ,] , "COMPOSITE_CURVE" => & ["name" , "segments" , "self_intersect" ,] , "COMPOSITE_CURVE_ON_SURFACE" => & ["name" , "segments" , "self_intersect" ,] , "COMPOSITE_CURVE_SEGMENT" => & ["transition" , "same_sense" , "parent_curve" ,] , "CONFIGURATION_DESIGN" => & ["configuration" , "design" ,] , "CONFIGURATION_EFFECTIVITY" => & ["id" , "usage" , "configuration" ,] , "CONFIGURATION_ITEM" => & ["id" , "name" , "description" , "item_concept" , "purpose" ,] , "CONIC" => & ["name" , "position" ,] , "CONICAL_SURFACE" => & ["name" , "position" , "radius" , "semi_angle" ,] , "CONNECTED_EDGE_SET" => & ["name" , "ces_edges" ,] , "CONNECTED_FACE_SET" => & ["name" , "cfs_faces" ,] , "CONTEXT_DEPENDENT_SHAPE_REPRESENTATION" => & ["representation_relation" , "represented_product_relation" ,] , "CONTEXT_DEPENDENT_UNIT" => & ["dimensions" , "name" ,] , "CONTRACT" => & ["name" , "purpose" , "kind" ,] , "CONTRACT_ASSIGNMENT" => & ["assigned_contract" ,] , "CONTRACT_TYPE" => & ["description" ,] , "CONVERSION_BASED_UNIT" => & ["dimensions" , "name" , "conversion_factor" ,] , "COORDINATED_UNIVERSAL_TIME_OFFSET" => & ["hour_offset" , "minute_offset" , "sense" ,] , "CURVE" => & ["name" ,] , "CURVE_BOUNDED_SURFACE" => & ["name" , "basis_surface" , "boundaries" , "implicit_outer" ,] , "CURVE_REPLICA" => & ["name" , "parent_curve" , "transformation" ,] , "CYLINDRICAL_SURFACE" => & ["name" , "position" , "radius" ,] , "DATE" => & ["year_component" ,] , "DATE_AND_TIME" => & ["date_component" , "time_component" ,] , "DATE_AND_TIME_ASSIGNMENT" => & ["assigned_date_and_time" , "role" ,] , "DATE_TIME_ROLE" => & ["name" ,] , "DATED_EFFECTIVITY" => & ["id" , "effectivity_start_date" , "effectivity_end_date" ,] , "DEFINITIONAL_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "DEGENERATE_PCURVE" => & ["name" , "basis_surface" , "reference_to_curve" ,] , "DEGENERATE_TOROIDAL_SURFACE" => & ["name" , "position" , "major_radius" , "minor_radius" , "select_outer" ,] , "DESIGN_CONTEXT" => & ["name" , "frame_of_reference" , "life_cycle_stage" ,] , "DESIGN_MAKE_FROM_RELATIONSHIP" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" ,] , "DIMENSIONAL_EXPONENTS" => & ["length_exponent" , "mass_exponent" , "time_exponent" , "electric_current_exponent" , "thermodynamic_temperature_exponent" , "amount_of_substance_exponent" , "luminous_intensity_exponent" ,] , "DIRECTED_ACTION" => & ["name" , "description" , "chosen_method" , "directive" ,] , "DIRECTION" => & ["name" , "direction_ratios" ,] , "DOCUMENT" => & ["id" , "name" , "description" , "kind" ,] , "DOCUMENT_REFERENCE" => & ["assigned_document" , "source" ,] , "DOCUMENT_RELATIONSHIP" => & ["name" , "description" , "relating_document" , "related_document" ,] , "DOCUMENT_TYPE" => & ["product_data_type" ,] , "DOCUMENT_USAGE_CONSTRAINT" => & ["source" , "subject_element" , "subject_element_value" ,] , "DOCUMENT_WITH_CLASS" => & ["id" , "name" , "description" , "kind" , "class" ,] , "EDGE" => & ["name" , "edge_start" , "edge_end" ,] , "EDGE_BASED_WIREFRAME_MODEL" => & ["name" , "ebwm_boundary" ,] , "EDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "EDGE_CURVE" => & ["name" , "edge_start" , "edge_end" , "edge_geometry" , "same_sense" ,] , "EDGE_LOOP" => & ["name" , "edge_list" ,] , "EFFECTIVITY" => & ["id" ,] , "ELEMENTARY_SURFACE" => & ["name" , "position" ,] , "ELLIPSE" => & ["name" , "position" , "semi_axis_1" , "semi_axis_2" ,] , "EVALUATED_DEGENERATE_PCURVE" => & ["name" , "basis_surface" , "reference_to_curve" , "equivalent_point" ,] , "EXECUTED_ACTION" => & ["name" , "description" , "chosen_method" ,] , "FACE" => & ["name" , "bounds" ,] , "FACE_BOUND" => & ["name" , "bound" , "orientation" ,] , "FACE_OUTER_BOUND" => & ["name" , "bound" , "orientation" ,] , "FACE_SURFACE" => & ["name" , "bounds" , "face_geometry" , "same_sense" ,] , "FACETED_BREP" => & ["name" , "outer" ,] , "FACETED_BREP_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "FOUNDED_ITEM" => & [] , "FUNCTIONALLY_DEFINED_TRANSFORMATION" => & ["name" , "description" ,] , "GEOMETRIC_CURVE_SET" => & ["name" , "elements" ,] , "GEOMETRIC_REPRESENTATION_CONTEXT" => & ["context_identifier" , "context_type" , "coordinate_space_dimension" ,] , "GEOMETRIC_REPRESENTATION_ITEM" => & ["name" ,] , "GEOMETRIC_SET" => & ["name" , "elements" ,] , "GEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "GEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "GLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT" => & ["context_identifier" , "context_type" , "uncertainty" ,] , "GLOBAL_UNIT_ASSIGNED_CONTEXT" => & ["context_identifier" , "context_type" , "units" ,] , "HYPERBOLA" => & ["name" , "position" , "semi_axis" , "semi_imag_axis" ,] , "INTERSECTION_CURVE" => & ["name" , "curve_3d" , "associated_geometry" , "master_representation" ,] , "ITEM_DEFINED_TRANSFORMATION" => & ["name" , "description" , "transform_item_1" , "transform_item_2" ,] , "LENGTH_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "LENGTH_UNIT" => & ["dimensions" ,] , "LINE" => & ["name" , "pnt" , "dir" ,] , "LOCAL_TIME" => & ["hour_component" , "minute_component" , "second_component" , "zone" ,] , "LOOP" => & ["name" ,] , "LOT_EFFECTIVITY" => & ["id" , "effectivity_lot_id" , "effectivity_lot_size" ,] , "MANIFOLD_SOLID_BREP" => & ["name" , "outer" ,] , "MANIFOLD_SURFACE_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "MAPPED_ITEM" => & ["name" , "mapping_source" , "mapping_target" ,] , "MASS_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "MASS_UNIT" => & ["dimensions" ,] , "MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "MECHANICAL_CONTEXT" => & ["name" , "frame_of_reference" , "discipline_type" ,] , "NAMED_UNIT" => & ["dimensions" ,] , "NEXT_ASSEMBLY_USAGE_OCCURRENCE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" , "reference_designator" ,] , "OFFSET_CURVE_3D" => & ["name" , "basis_curve" , "distance" , "self_intersect" , "ref_direction" ,] , "OFFSET_SURFACE" => & ["name" , "basis_surface" , "distance" , "self_intersect" ,] , "OPEN_SHELL" => & ["name" , "cfs_faces" ,] , "ORDINAL_DATE" => & ["year_component" , "day_component" ,] , "ORGANIZATION" => & ["id" , "name" , "description" ,] , "ORGANIZATION_RELATIONSHIP" => & ["name" , "description" , "relating_organization" , "related_organization" ,] , "ORGANIZATIONAL_ADDRESS" => & ["internal_location" , "street_number" , "street" , "postal_box" , "town" , "region" , "postal_code" , "country" , "facsimile_number" , "telephone_number" , "electronic_mail_address" , "telex_number" , "organizations" , "description" ,] , "ORGANIZATIONAL_PROJECT" => & ["name" , "description" , "responsible_organizations" ,] , "ORIENTED_CLOSED_SHELL" => & ["name" , "cfs_faces" , "closed_shell_element" , "orientation" ,] , "ORIENTED_EDGE" => & ["name" , "edge_start" , "edge_end" , "edge_element" , "orientation" ,] , "ORIENTED_FACE" => & ["name" , "bounds" , "face_element" , "orientation" ,] , "ORIENTED_OPEN_SHELL" => & ["name" , "cfs_faces" , "open_shell_element" , "orientation" ,] , "ORIENTED_PATH" => & ["name" , "edge_list" , "path_element" , "orientation" ,] , "OUTER_BOUNDARY_CURVE" => & ["name" , "segments" , "self_intersect" ,] , "PARABOLA" => & ["name" , "position" , "focal_dist" ,] , "PARAMETRIC_REPRESENTATION_CONTEXT" => & ["context_identifier" , "context_type" ,] , "PATH" => & ["name" , "edge_list" ,] , "PCURVE" => & ["name" , "basis_surface" , "reference_to_curve" ,] , "PERSON" => & ["id" , "last_name" , "first_name" , "middle_names" , "prefix_titles" , "suffix_titles" ,] , "PERSON_AND_ORGANIZATION" => & ["the_person" , "the_organization" ,] , "PERSON_AND_ORGANIZATION_ASSIGNMENT" => & ["assigned_person_and_organization" , "role" ,] , "PERSON_AND_ORGANIZATION_ROLE" => & ["name" ,] , "PERSONAL_ADDRESS" => & ["internal_location" , "street_number" , "street" , "postal_box" , "town" , "region" , "postal_code" , "country" , "facsimile_number" , "telephone_number" , "electronic_mail_address" , "telex_number" , "people" , "description" ,] , "PLACEMENT" => & ["name" , "location" ,] , "PLANE" => & ["name" , "position" ,] , "PLANE_ANGLE_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "PLANE_ANGLE_UNIT" => & ["dimensions" ,] , "POINT" => & ["name" ,] , "POINT_ON_CURVE" => & ["name" , "basis_curve" , "point_parameter" ,] , "POINT_ON_SURFACE" => & ["name" , "basis_surface" , "point_parameter_u" , "point_parameter_v" ,] , "POINT_REPLICA" => & ["name" , "parent_pt" , "transformation" ,] , "POLY_LOOP" => & ["name" , "polygon" ,] , "POLYLINE" => & ["name" , "points" ,] , "PRODUCT" => & ["id" , "name" , "description" , "frame_of_reference" ,] , "PRODUCT_CATEGORY" => & ["name" , "description" ,] , "PRODUCT_CATEGORY_RELATIONSHIP" => & ["name" , "description" , "category" , "sub_category" ,] , "PRODUCT_CONCEPT" => & ["id" , "name" , "description" , "market_context" ,] , "PRODUCT_CONCEPT_CONTEXT" => & ["name" , "frame_of_reference" , "market_segment_type" ,] , "PRODUCT_CONTEXT" => & ["name" , "frame_of_reference" , "discipline_type" ,] , "PRODUCT_DEFINITION" => & ["id" , "description" , "formation" , "frame_of_reference" ,] , "PRODUCT_DEFINITION_CONTEXT" => & ["name" , "frame_of_reference" , "life_cycle_stage" ,] , "PRODUCT_DEFINITION_EFFECTIVITY" => & ["id" , "usage" ,] , "PRODUCT_DEFINITION_FORMATION" => & ["id" , "description" , "of_product" ,] , "PRODUCT_DEFINITION_FORMATION_WITH_SPECIFIED_SOURCE" => & ["id" , "description" , "of_product" , "make_or_buy" ,] , "PRODUCT_DEFINITION_RELATIONSHIP" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" ,] , "PRODUCT_DEFINITION_SHAPE" => & ["name" , "description" , "definition" ,] , "PRODUCT_DEFINITION_USAGE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" ,] , "PRODUCT_DEFINITION_WITH_ASSOCIATED_DOCUMENTS" => & ["id" , "description" , "formation" , "frame_of_reference" , "documentation_ids" ,] , "PRODUCT_RELATED_PRODUCT_CATEGORY" => & ["name" , "description" , "products" ,] , "PROMISSORY_USAGE_OCCURRENCE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" , "reference_designator" ,] , "PROPERTY_DEFINITION" => & ["name" , "description" , "definition" ,] , "PROPERTY_DEFINITION_REPRESENTATION" => & ["definition" , "used_representation" ,] , "QUANTIFIED_ASSEMBLY_COMPONENT_USAGE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" , "reference_designator" , "quantity" ,] , "QUASI_UNIFORM_CURVE" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" ,] , "QUASI_UNIFORM_SURFACE" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" ,] , "RATIONAL_B_SPLINE_CURVE" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" , "weights_data" ,] , "RATIONAL_B_SPLINE_SURFACE" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" , "weights_data" ,] , "RECTANGULAR_COMPOSITE_SURFACE" => & ["name" , "segments" ,] , "RECTANGULAR_TRIMMED_SURFACE" => & ["name" , "basis_surface" , "u1" , "u2" , "v1" , "v2" , "usense" , "vsense" ,] , "REPARAMETRISED_COMPOSITE_CURVE_SEGMENT" => & ["transition" , "same_sense" , "parent_curve" , "param_length" ,] , "REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "REPRESENTATION_CONTEXT" => & ["context_identifier" , "context_type" ,] , "REPRESENTATION_ITEM" => & ["name" ,] , "REPRESENTATION_MAP" => & ["mapping_origin" , "mapped_representation" ,] , "REPRESENTATION_RELATIONSHIP" => & ["name" , "description" , "rep_1" , "rep_2" ,] , "REPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION" => & ["name" , "description" , "rep_1" , "rep_2" , "transformation_operator" ,] , "SEAM_CURVE" => & ["name" , "curve_3d" , "associated_geometry" , "master_representation" ,] , "SECURITY_CLASSIFICATION" => & ["name" , "purpose" , "security_level" ,] , "SECURITY_CLASSIFICATION_ASSIGNMENT" => & ["assigned_security_classification" ,] , "SECURITY_CLASSIFICATION_LEVEL" => & ["name" ,] , "SERIAL_NUMBERED_EFFECTIVITY" => & ["id" , "effectivity_start_id" , "effectivity_end_id" ,] , "SHAPE_ASPECT" => & ["name" , "description" , "of_shape" , "product_definitional" ,] , "SHAPE_ASPECT_RELATIONSHIP" => & ["name" , "description" , "relating_shape_aspect" , "related_shape_aspect" ,] , "SHAPE_DEFINITION_REPRESENTATION" => & ["definition" , "used_representation" ,] , "SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "SHAPE_REPRESENTATION_RELATIONSHIP" => & ["name" , "description" , "rep_1" , "rep_2" ,] , "SHELL_BASED_SURFACE_MODEL" => & ["name" , "sbsm_boundary" ,] , "SHELL_BASED_WIREFRAME_MODEL" => & ["name" , "sbwm_boundary" ,] , "SHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "SI_UNIT" => & ["dimensions" , "prefix" , "name" ,] , "SOLID_ANGLE_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "SOLID_ANGLE_UNIT" => & ["dimensions" ,] , "SOLID_MODEL" => & ["name" ,] , "SPECIFIED_HIGHER_USAGE_OCCURRENCE" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" , "reference_designator" , "upper_usage" , "next_usage" ,] , "SPHERICAL_SURFACE" => & ["name" , "position" , "radius" ,] , "START_REQUEST" => & ["assigned_action_request" , "items" ,] , "START_WORK" => & ["assigned_action" , "items" ,] , "SUPPLIED_PART_RELATIONSHIP" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" ,] , "SURFACE" => & ["name" ,] , "SURFACE_CURVE" => & ["name" , "curve_3d" , "associated_geometry" , "master_representation" ,] , "SURFACE_OF_LINEAR_EXTRUSION" => & ["name" , "swept_curve" , "extrusion_axis" ,] , "SURFACE_OF_REVOLUTION" => & ["name" , "swept_curve" , "axis_position" ,] , "SURFACE_PATCH" => & ["parent_surface" , "u_transition" , "v_transition" , "u_sense" , "v_sense" ,] , "SURFACE_REPLICA" => & ["name" , "parent_surface" , "transformation" ,] , "SWEPT_SURFACE" => & ["name" , "swept_curve" ,] , "TOPOLOGICAL_REPRESENTATION_ITEM" => & ["name" ,] , "TOROIDAL_SURFACE" => & ["name" , "position" , "major_radius" , "minor_radius" ,] , "TRIMMED_CURVE" => & ["name" , "basis_curve" , "trim_1" , "trim_2" , "sense_agreement" , "master_representation" ,] , "UNCERTAINTY_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" , "name" , "description" ,] , "UNIFORM_CURVE" => & ["name" , "degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" ,] , "UNIFORM_SURFACE" => & ["name" , "u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" ,] , "VECTOR" => & ["name" , "orientation" , "magnitude" ,] , "VERSIONED_ACTION_REQUEST" => & ["id" , "version" , "purpose" , "description" ,] , "VERTEX" => & ["name" ,] , "VERTEX_LOOP" => & ["name" , "loop_vertex" ,] , "VERTEX_POINT" => & ["name" , "vertex_geometry" ,] , "VERTEX_SHELL" => & ["name" , "vertex_shell_extent" ,] , "VOLUME_MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "VOLUME_UNIT" => & ["dimensions" ,] , "WEEK_OF_YEAR_AND_DAY_DATE" => & ["year_component" , "week_component" , "day_component" ,] , "WIRE_SHELL" => & ["name" , "wire_shell_extent" ,] , };
    static PARTIALS: ::phf::Map<&'static str, &'static [&'static str]> = ::phf::phf_map! { "ACTION" => & ["name" , "description" , "chosen_method" ,] , "ACTION_ASSIGNMENT" => & ["assigned_action" ,] , "ACTION_DIRECTIVE" => & ["name" , "description" , "analysis" , "comment" , "requests" ,] , "ACTION_METHOD" => & ["name" , "description" , "consequence" , "purpose" ,] , "ACTION_REQUEST_ASSIGNMENT" => & ["assigned_action_request" ,] , "ACTION_REQUEST_SOLUTION" => & ["method" , "request" ,] , "ACTION_REQUEST_STATUS" => & ["status" , "assigned_request" ,] , "ACTION_STATUS" => & ["status" , "assigned_action" ,] , "ADDRESS" => & ["internal_location" , "street_number" , "street" , "postal_box" , "town" , "region" , "postal_code" , "country" , "facsimile_number" , "telephone_number" , "electronic_mail_address" , "telex_number" ,] , "ADVANCED_BREP_SHAPE_REPRESENTATION" => & [] , "ADVANCED_FACE" => & [] , "ALTERNATE_PRODUCT_RELATIONSHIP" => & ["name" , "definition" , "alternate" , "base" , "basis" ,] , "APPLICATION_CONTEXT" => & ["application" ,] , "APPLICATION_CONTEXT_ELEMENT" => & ["name" , "frame_of_reference" ,] , "APPLICATION_PROTOCOL_DEFINITION" => & ["status" , "application_interpreted_model_schema_name" , "application_protocol_year" , "application" ,] , "APPROVAL" => & ["status" , "level" ,] , "APPROVAL_ASSIGNMENT" => & ["assigned_approval" ,] , "APPROVAL_DATE_TIME" => & ["date_time" , "dated_approval" ,] , "APPROVAL_PERSON_ORGANIZATION" => & ["person_organization" , "authorized_approval" , "role" ,] , "APPROVAL_RELATIONSHIP" => & ["name" , "description" , "relating_approval" , "related_approval" ,] , "APPROVAL_ROLE" => & ["role" ,] , "APPROVAL_STATUS" => & ["name" ,] , "AREA_MEASURE_WITH_UNIT" => & [] , "AREA_UNIT" => & [] , "ASSEMBLY_COMPONENT_USAGE" => & ["reference_designator" ,] , "ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE" => & ["name" , "definition" , "base" , "substitute" ,] , "AXIS1_PLACEMENT" => & ["axis" ,] , "AXIS2_PLACEMENT_2D" => & ["ref_direction" ,] , "AXIS2_PLACEMENT_3D" => & ["axis" , "ref_direction" ,] , "B_SPLINE_CURVE" => & ["degree" , "control_points_list" , "curve_form" , "closed_curve" , "self_intersect" ,] , "B_SPLINE_CURVE_WITH_KNOTS" => & ["knot_multiplicities" , "knots" , "knot_spec" ,] , "B_SPLINE_SURFACE" => & ["u_degree" , "v_degree" , "control_points_list" , "surface_form" , "u_closed" , "v_closed" , "self_intersect" ,] , "B_SPLINE_SURFACE_WITH_KNOTS" => & ["u_multiplicities" , "v_multiplicities" , "u_knots" , "v_knots" , "knot_spec" ,] , "BEZIER_CURVE" => & [] , "BEZIER_SURFACE" => & [] , "BOUNDARY_CURVE" => & [] , "BOUNDED_CURVE" => & [] , "BOUNDED_PCURVE" => & [] , "BOUNDED_SURFACE" => & [] , "BOUNDED_SURFACE_CURVE" => & [] , "BREP_WITH_VOIDS" => & ["voids" ,] , "CALENDAR_DATE" => & ["day_component" , "month_component" ,] , "CARTESIAN_POINT" => & ["coordinates" ,] , "CARTESIAN_TRANSFORMATION_OPERATOR" => & ["axis1" , "axis2" , "local_origin" , "scale" ,] , "CARTESIAN_TRANSFORMATION_OPERATOR_3D" => & ["axis3" ,] , "CC_DESIGN_APPROVAL" => & ["items" ,] , "CC_DESIGN_CERTIFICATION" => & ["items" ,] , "CC_DESIGN_CONTRACT" => & ["items" ,] , "CC_DESIGN_DATE_AND_TIME_ASSIGNMENT" => & ["items" ,] , "CC_DESIGN_PERSON_AND_ORGANIZATION_ASSIGNMENT" => & ["items" ,] , "CC_DESIGN_SECURITY_CLASSIFICATION" => & ["items" ,] , "CC_DESIGN_SPECIFICATION_REFERENCE" => & ["items" ,] , "CERTIFICATION" => & ["name" , "purpose" , "kind" ,] , "CERTIFICATION_ASSIGNMENT" => & ["assigned_certification" ,] , "CERTIFICATION_TYPE" => & ["description" ,] , "CHANGE" => & ["items" ,] , "CHANGE_REQUEST" => & ["items" ,] , "CIRCLE" => & ["radius" ,] , "CLOSED_SHELL" => & [] , "COMPOSITE_CURVE" => & ["segments" , "self_intersect" ,] , "COMPOSITE_CURVE_ON_SURFACE" => & [] , "COMPOSITE_CURVE_SEGMENT" => & ["transition" , "same_sense" , "parent_curve" ,] , "CONFIGURATION_DESIGN" => & ["configuration" , "design" ,] , "CONFIGURATION_EFFECTIVITY" => & ["configuration" ,] , "CONFIGURATION_ITEM" => & ["id" , "name" , "description" , "item_concept" , "purpose" ,] , "CONIC" => & ["position" ,] , "CONICAL_SURFACE" => & ["radius" , "semi_angle" ,] , "CONNECTED_EDGE_SET" => & ["ces_edges" ,] , "CONNECTED_FACE_SET" => & ["cfs_faces" ,] , "CONTEXT_DEPENDENT_SHAPE_REPRESENTATION" => & ["representation_relation" , "represented_product_relation" ,] , "CONTEXT_DEPENDENT_UNIT" => & ["name" ,] , "CONTRACT" => & ["name" , "purpose" , "kind" ,] , "CONTRACT_ASSIGNMENT" => & ["assigned_contract" ,] , "CONTRACT_TYPE" => & ["description" ,] , "CONVERSION_BASED_UNIT" => & ["name" , "conversion_factor" ,] , "COORDINATED_UNIVERSAL_TIME_OFFSET" => & ["hour_offset" , "minute_offset" , "sense" ,] , "CURVE" => & [] , "CURVE_BOUNDED_SURFACE" => & ["basis_surface" , "boundaries" , "implicit_outer" ,] , "CURVE_REPLICA" => & ["parent_curve" , "transformation" ,] , "CYLINDRICAL_SURFACE" => & ["radius" ,] , "DATE" => & ["year_component" ,] , "DATE_AND_TIME" => & ["date_component" , "time_component" ,] , "DATE_AND_TIME_ASSIGNMENT" => & ["assigned_date_and_time" , "role" ,] , "DATE_TIME_ROLE" => & ["name" ,] , "DATED_EFFECTIVITY" => & ["effectivity_start_date" , "effectivity_end_date" ,] , "DEFINITIONAL_REPRESENTATION" => & [] , "DEGENERATE_PCURVE" => & ["basis_surface" , "reference_to_curve" ,] , "DEGENERATE_TOROIDAL_SURFACE" => & ["select_outer" ,] , "DESIGN_CONTEXT" => & [] , "DESIGN_MAKE_FROM_RELATIONSHIP" => & [] , "DIMENSIONAL_EXPONENTS" => & ["length_exponent" , "mass_exponent" , "time_exponent" , "electric_current_exponent" , "thermodynamic_temperature_exponent" , "amount_of_substance_exponent" , "luminous_intensity_exponent" ,] , "DIRECTED_ACTION" => & ["directive" ,] , "DIRECTION" => & ["direction_ratios" ,] , "DOCUMENT" => & ["id" , "name" , "description" , "kind" ,] , "DOCUMENT_REFERENCE" => & ["assigned_document" , "source" ,] , "DOCUMENT_RELATIONSHIP" => & ["name" , "description" , "relating_document" , "related_document" ,] , "DOCUMENT_TYPE" => & ["product_data_type" ,] , "DOCUMENT_USAGE_CONSTRAINT" => & ["source" , "subject_element" , "subject_element_value" ,] , "DOCUMENT_WITH_CLASS" => & ["class" ,] , "EDGE" => & ["edge_start" , "edge_end" ,] , "EDGE_BASED_WIREFRAME_MODEL" => & ["ebwm_boundary" ,] , "EDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION" => & [] , "EDGE_CURVE" => & ["edge_geometry" , "same_sense" ,] , "EDGE_LOOP" => & [] , "EFFECTIVITY" => & ["id" ,] , "ELEMENTARY_SURFACE" => & ["position" ,] , "ELLIPSE" => & ["semi_axis_1" , "semi_axis_2" ,] , "EVALUATED_DEGENERATE_PCURVE" => & ["equivalent_point" ,] , "EXECUTED_ACTION" => & [] , "FACE" => & ["bounds" ,] , "FACE_BOUND" => & ["bound" , "orientation" ,] , "FACE_OUTER_BOUND" => & [] , "FACE_SURFACE" => & ["face_geometry" , "same_sense" ,] , "FACETED_BREP" => & [] , "FACETED_BREP_SHAPE_REPRESENTATION" => & [] , "FOUNDED_ITEM" => & [] , "FUNCTIONALLY_DEFINED_TRANSFORMATION" => & ["name" , "description" ,] , "GEOMETRIC_CURVE_SET" => & [] , "GEOMETRIC_REPRESENTATION_CONTEXT" => & ["coordinate_space_dimension" ,] , "GEOMETRIC_REPRESENTATION_ITEM" => & [] , "GEOMETRIC_SET" => & ["elements" ,] , "GEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION" => & [] , "GEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION" => & [] , "GLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT" => & ["uncertainty" ,] , "GLOBAL_UNIT_ASSIGNED_CONTEXT" => & ["units" ,] , "HYPERBOLA" => & ["semi_axis" , "semi_imag_axis" ,] , "INTERSECTION_CURVE" => & [] , "ITEM_DEFINED_TRANSFORMATION" => & ["name" , "description" , "transform_item_1" , "transform_item_2" ,] , "LENGTH_MEASURE_WITH_UNIT" => & [] , "LENGTH_UNIT" => & [] , "LINE" => & ["pnt" , "dir" ,] , "LOCAL_TIME" => & ["hour_component" , "minute_component" , "second_component" , "zone" ,] , "LOOP" => & [] , "LOT_EFFECTIVITY" => & ["effectivity_lot_id" , "effectivity_lot_size" ,] , "MANIFOLD_SOLID_BREP" => & ["outer" ,] , "MANIFOLD_SURFACE_SHAPE_REPRESENTATION" => & [] , "MAPPED_ITEM" => & ["mapping_source" , "mapping_target" ,] , "MASS_MEASURE_WITH_UNIT" => & [] , "MASS_UNIT" => & [] , "MEASURE_WITH_UNIT" => & ["value_component" , "unit_component" ,] , "MECHANICAL_CONTEXT" => & [] , "NAMED_UNIT" => & ["dimensions" ,] , "NEXT_ASSEMBLY_USAGE_OCCURRENCE" => & [] , "OFFSET_CURVE_3D" => & ["basis_curve" , "distance" , "self_intersect" , "ref_direction" ,] , "OFFSET_SURFACE" => & ["basis_surface" , "distance" , "self_intersect" ,] , "OPEN_SHELL" => & [] , "ORDINAL_DATE" => & ["day_component" ,] , "ORGANIZATION" => & ["id" , "name" , "description" ,] , "ORGANIZATION_RELATIONSHIP" => & ["name" , "description" , "relating_organization" , "related_organization" ,] , "ORGANIZATIONAL_ADDRESS" => & ["organizations" , "description" ,] , "ORGANIZATIONAL_PROJECT" => & ["name" , "description" , "responsible_organizations" ,] , "ORIENTED_CLOSED_SHELL" => & ["closed_shell_element" , "orientation" ,] , "ORIENTED_EDGE" => & ["edge_element" , "orientation" ,] , "ORIENTED_FACE" => & ["face_element" , "orientation" ,] , "ORIENTED_OPEN_SHELL" => & ["open_shell_element" , "orientation" ,] , "ORIENTED_PATH" => & ["path_element" , "orientation" ,] , "OUTER_BOUNDARY_CURVE" => & [] , "PARABOLA" => & ["focal_dist" ,] , "PARAMETRIC_REPRESENTATION_CONTEXT" => & [] , "PATH" => & ["edge_list" ,] , "PCURVE" => & ["basis_surface" , "reference_to_curve" ,] , "PERSON" => & ["id" , "last_name" , "first_name" , "middle_names" , "prefix_titles" , "suffix_titles" ,] , "PERSON_AND_ORGANIZATION" => & ["the_person" , "the_organization" ,] , "PERSON_AND_ORGANIZATION_ASSIGNMENT" => & ["assigned_person_and_organization" , "role" ,] , "PERSON_AND_ORGANIZATION_ROLE" => & ["name" ,] , "PERSONAL_ADDRESS" => & ["people" , "description" ,] , "PLACEMENT" => & ["location" ,] , "PLANE" => & [] , "PLANE_ANGLE_MEASURE_WITH_UNIT" => & [] , "PLANE_ANGLE_UNIT" => & [] , "POINT" => & [] , "POINT_ON_CURVE" => & ["basis_curve" , "point_parameter" ,] , "POINT_ON_SURFACE" => & ["basis_surface" , "point_parameter_u" , "point_parameter_v" ,] , "POINT_REPLICA" => & ["parent_pt" , "transformation" ,] , "POLY_LOOP" => & ["polygon" ,] , "POLYLINE" => & ["points" ,] , "PRODUCT" => & ["id" , "name" , "description" , "frame_of_reference" ,] , "PRODUCT_CATEGORY" => & ["name" , "description" ,] , "PRODUCT_CATEGORY_RELATIONSHIP" => & ["name" , "description" , "category" , "sub_category" ,] , "PRODUCT_CONCEPT" => & ["id" , "name" , "description" , "market_context" ,] , "PRODUCT_CONCEPT_CONTEXT" => & ["market_segment_type" ,] , "PRODUCT_CONTEXT" => & ["discipline_type" ,] , "PRODUCT_DEFINITION" => & ["id" , "description" , "formation" , "frame_of_reference" ,] , "PRODUCT_DEFINITION_CONTEXT" => & ["life_cycle_stage" ,] , "PRODUCT_DEFINITION_EFFECTIVITY" => & ["usage" ,] , "PRODUCT_DEFINITION_FORMATION" => & ["id" , "description" , "of_product" ,] , "PRODUCT_DEFINITION_FORMATION_WITH_SPECIFIED_SOURCE" => & ["make_or_buy" ,] , "PRODUCT_DEFINITION_RELATIONSHIP" => & ["id" , "name" , "description" , "relating_product_definition" , "related_product_definition" ,] , "PRODUCT_DEFINITION_SHAPE" => & [] , "PRODUCT_DEFINITION_USAGE" => & [] , "PRODUCT_DEFINITION_WITH_ASSOCIATED_DOCUMENTS" => & ["documentation_ids" ,] , "PRODUCT_RELATED_PRODUCT_CATEGORY" => & ["products" ,] , "PROMISSORY_USAGE_OCCURRENCE" => & [] , "PROPERTY_DEFINITION" => & ["name" , "description" , "definition" ,] , "PROPERTY_DEFINITION_REPRESENTATION" => & ["definition" , "used_representation" ,] , "QUANTIFIED_ASSEMBLY_COMPONENT_USAGE" => & ["quantity" ,] , "QUASI_UNIFORM_CURVE" => & [] , "QUASI_UNIFORM_SURFACE" => & [] , "RATIONAL_B_SPLINE_CURVE" => & ["weights_data" ,] , "RATIONAL_B_SPLINE_SURFACE" => & ["weights_data" ,] , "RECTANGULAR_COMPOSITE_SURFACE" => & ["segments" ,] , "RECTANGULAR_TRIMMED_SURFACE" => & ["basis_surface" , "u1" , "u2" , "v1" , "v2" , "usense" , "vsense" ,] , "REPARAMETRISED_COMPOSITE_CURVE_SEGMENT" => & ["param_length" ,] , "REPRESENTATION" => & ["name" , "items" , "context_of_items" ,] , "REPRESENTATION_CONTEXT" => & ["context_identifier" , "context_type" ,] , "REPRESENTATION_ITEM" => & ["name" ,] , "REPRESENTATION_MAP" => & ["mapping_origin" , "mapped_representation" ,] , "REPRESENTATION_RELATIONSHIP" => & ["name" , "description" , "rep_1" , "rep_2" ,] , "REPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION" => & ["transformation_operator" ,] , "SEAM_CURVE" => & [] , "SECURITY_CLASSIFICATION" => & ["name" , "purpose" , "security_level" ,] , "SECURITY_CLASSIFICATION_ASSIGNMENT" => & ["assigned_security_classification" ,] , "SECURITY_CLASSIFICATION_LEVEL" => & ["name" ,] , "SERIAL_NUMBERED_EFFECTIVITY" => & ["effectivity_start_id" , "effectivity_end_id" ,] , "SHAPE_ASPECT" => & ["name" , "description" , "of_shape" , "product_definitional" ,] , "SHAPE_ASPECT_RELATIONSHIP" => & ["name" , "description" , "relating_shape_aspect" , "related_shape_aspect" ,] , "SHAPE_DEFINITION_REPRESENTATION" => & [] , "SHAPE_REPRESENTATION" => & [] , "SHAPE_REPRESENTATION_RELATIONSHIP" => & [] , "SHELL_BASED_SURFACE_MODEL" => & ["sbsm_boundary" ,] , "SHELL_BASED_WIREFRAME_MODEL" => & ["sbwm_boundary" ,] , "SHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION" => & [] , "SI_UNIT" => & ["prefix" , "name" ,] , "SOLID_ANGLE_MEASURE_WITH_UNIT" => & [] , "SOLID_ANGLE_UNIT" => & [] , "SOLID_MODEL" => & [] , "SPECIFIED_HIGHER_USAGE_OCCURRENCE" => & ["upper_usage" , "next_usage" ,] , "SPHERICAL_SURFACE" => & ["radius" ,] , "START_REQUEST" => & ["items" ,] , "START_WORK" => & ["items" ,] , "SUPPLIED_PART_RELATIONSHIP" => & [] , "SURFACE" => & [] , "SURFACE_CURVE" => & ["curve_3d" , "associated_geometry" , "master_representation" ,] , "SURFACE_OF_LINEAR_EXTRUSION" => & ["extrusion_axis" ,] , "SURFACE_OF_REVOLUTION" => & ["axis_position" ,] , "SURFACE_PATCH" => & ["parent_surface" , "u_transition" , "v_transition" , "u_sense" , "v_sense" ,] , "SURFACE_REPLICA" => & ["parent_surface" , "transformation" ,] , "SWEPT_SURFACE" => & ["swept_curve" ,] , "TOPOLOGICAL_REPRESENTATION_ITEM" => & [] , "TOROIDAL_SURFACE" => & ["major_radius" , "minor_radius" ,] , "TRIMMED_CURVE" => & ["basis_curve" , "trim_1" , "trim_2" , "sense_agreement" , "master_representation" ,] , "UNCERTAINTY_MEASURE_WITH_UNIT" => & ["name" , "description" ,] , "UNIFORM_CURVE" => & [] , "UNIFORM_SURFACE" => & [] , "VECTOR" => & ["orientation" , "magnitude" ,] , "VERSIONED_ACTION_REQUEST" => & ["id" , "version" , "purpose" , "description" ,] , "VERTEX" => & [] , "VERTEX_LOOP" => & ["loop_vertex" ,] , "VERTEX_POINT" => & ["vertex_geometry" ,] , "VERTEX_SHELL" => & ["vertex_shell_extent" ,] , "VOLUME_MEASURE_WITH_UNIT" => & [] , "VOLUME_UNIT" => & [] , "WEEK_OF_YEAR_AND_DAY_DATE" => & ["week_component" , "day_component" ,] , "WIRE_SHELL" => & ["wire_shell_extent" ,] , };
